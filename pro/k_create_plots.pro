...
run_fit_coeffs,'test',savfile='all.default.sav',/evenz, $
	modelzlim=0.25
stop
...
;k_speck,'main.default.sav','all.default.specK.0.1.sav',subsample=5, to_z=0.1
;$touch gotpast
;k_speck,'lrg.default.sav','all.default.specK.0.3.sav',subsample=5, to_z=0.3
