pro k_create_plots,version,vpath, addgrgap=addgrgap, sdssfix=sdssfix, vconstraint=vconstraint
...
k_colors_plot,'lrg.'+version+'.sav',psfile='lrg_colors_plot.z0.2.ps', $
  ...
  zsplit=[0.2,0.3,0.4], version=version, vpath=vpath
...
k_kcorrect_grdiff_plot,'all.'+version+'.sav', $
  psfile='k_kcorrect_grdiff_plot.ps', subsample=4,to_z=0.1
stop
