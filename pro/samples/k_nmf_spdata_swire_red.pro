...
;-
;------------------------------------------------------------------------------
pro k_nmf_spdata_swire_red, mmatrix=mmatrix, sample=sample, flux=flux
...
if(NOT keyword_set(nswire)) then nswire=120L
...
;; collect some swire photometry 
    ...
    ired=where(gmr gt sp.z*3.+0.55 and gmr lt 3.)
    gmr=gmr[ired]
    swire_maggies=swire_maggies[*,ired]
    swire_ivar=swire_ivar[*,ired]
    swire=swire[ired]
