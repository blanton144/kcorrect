...
;-
pro lf_mock_npgauss,ntotal,mmin,mmax,fgot,area,absmk,phi,p,q,sigabsmag, $
                    sample_absmmin,sample_absmmax,model_absmmin, $
                    model_absmmax, sample_zmin,sample_zmax, $
