...
for i=0L, nv-1L do $
  coeffs[i,indx]=ranscale*coeffs[i,indx]/rec_maggies0[2,*]
...
center=dblarr(nv)
for i=0L, nv-1L do $
  center[i]=djs_avsigclip(alog10(coeffs[i,indx]),sigrej=3.)
...
for i=1, 72 do begin & plot,newcoeffs[0,*],newcoeffs[i,*],psym=4 & wait,0.2 & endfor
nuse=nv-1
