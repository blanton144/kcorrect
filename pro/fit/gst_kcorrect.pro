...
;-
;------------------------------------------------------------------------------
function gst_kcorrect, redshift, nmgy=nmgy, ivar=ivar, mag=mag, err=err, $
                       ...
                       twomass=twomass, omega0=omega0, omegal0=omegal0

common com_gst_kcorrect, rmatrix, zvals, band_shift, vname
...
mgy=fltarr(10, n_elements(redshift))
mgy_ivar=fltarr(10, n_elements(redshift))
