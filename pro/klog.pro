...
function klog_trim, v

   common com_klog_trim, qcompress
...
;------------------------------------------------------------------------------
pro klog, noname=noname, prelog=prelog, $
 ...
 v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, _EXTRA=extra
   ...
   common com_klog, loglun, fullprelog
   common com_klog_trim, qcompress

   if (keyword_set(filename)) then begin
      ; First close a file if one is already open
      if (keyword_set(loglun)) then klog, /close
