...
$k(z)$ in \citet{frie94a} is incorrect; in fact, $k(z)\equiv K(z)$.}
...
figures for this paper is {\tt kcorrect v1\_9}.
...
$\ambda_{\mathrm{min}} <\lambda < \lambda_{\mathrm{max}}$).
...
The version of the $K$-correction code ({\tt v1\_9}) implementing the
