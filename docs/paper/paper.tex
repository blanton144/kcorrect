...
types of magnitudes using the dust maps of \citet{schlegel98a}. {\tt
describe fiber mags}
...
redshift. However, we can test the $K$-correction method by applying
it to the SDSS fiber magnitudes. We again group the galaxies into Main
Sample galaxies and LRG galaxies, and do this problem separately for
objects $K$-corrected to $z=0.1$ and objects $K$-corrections to
$z=0.3$, respectively.

Nevertheless, in Figure \ref{k_speck_plot.fiber.0.1}, we compare the
