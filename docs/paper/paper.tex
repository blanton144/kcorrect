...
galaxy properties which are consistent over a range of redshifts.  As
part of the task of addressing these questions, which we will
investigate in subsequent papers, we implement here the method of
...
magnitudes of galaxies to the precision of the photometry. Expressed
in the correct coordinate system, the distribution of the coefficients
of the templates is planar, and in fact nearly linear. The resulting
