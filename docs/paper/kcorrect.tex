...
metallicity). In the near-IR, the spectra of thermally-pulsating
asymptotic giant branch stars may dominate the flux in certain
intermediate age populations (2--3 Gyr). Again, the fraction of stars
in this phase and what their spectra are is under dispute. {\bf what
does BC03 do?}  We do not address these uncertainties here, though we
...
described in \cite{stoughton01a} and elsewhere.
...
quantities.  However, in this section 
