...
the \citet{chabrier03} initial mass function, which makes some of this
...
relationship that \citet{bell01a} give based on their fits to spiral
galaxies. For blue galaxies ($B-V < 0.8$) this line is indeed a good
fit to our results. For the typical red galaxy, the \citet{bell01a}
...
We have fit several different sets of templates that we are releasing
with the data. 
