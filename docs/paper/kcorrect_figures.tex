...
\caption{\label{umr_bg} Fraction of the total star-formation that has
	occurred in the previous billion years $b_G$, as a function of
	restframe $u-r$ color, for SDSS galaxies. The greyscale is the
	conditional distribution of $b_G$ on $u-r$. The lines are the 10\%,
	25\%, 50\%, 75\% and 90\% quantiles. For $u-r < 2.5$, the median
	relationship follows the simple form listed in the figure. Galaxies
	with $u-r > 2.5$ are often highly reddened star-forming
	galaxies. For comparison we show the results of using the scaling of
	\citet{hopkins03a} and multiplying by a factor of four to account
