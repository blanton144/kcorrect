...
\figurenum{\fignum}
\plotone{mtol.ps}
\caption{\label{mtol} Mass-to-light ratios of galaxies (in solar
units) as a function of galaxy color. The solid line satisfies the
relationship $\log_{10}(M/L) = 1.65 (g-r) - 0.54$, which has 
the same slope as that found by \citet{bell01a}, with a higher
normalization by 0.3 dex.}
\end{figure}
