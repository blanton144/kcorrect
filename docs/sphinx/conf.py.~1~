...
from robostrategy import __version__
...
project = 'robostrategy'
copyright = '{0}, {1}'.format('2018', 'Michael Blanton')
...
htmlhelp_basename = '{0}pdoc'.format('robostrategy')
...
man_pages = [
    (master_doc, 'robostrategy', u'{0} Documentation'.format(project),
     [author], 1)
]
