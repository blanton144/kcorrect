...
C
 1000 FORMAT(/8X,' *** QL: Matrix G was enlarged',I3,
     1        '-times by unit matrix')
 1100 FORMAT(/8X,' *** QL: Constraint ',I5,
     1        ' not consistent to ',/,(10X,10I5))
 1200 FORMAT(/8X,' *** QL: LWAR too small')
 1210 FORMAT(/8X,' *** QL: LIWAR too small')
 1220 FORMAT(/8X,' *** QL: MNN too small')
 1300 FORMAT(/8X,' *** QL: Too many iterations (more than',I6,')')
 1400 FORMAT(/8X,' *** QL: Accuracy insufficient to attain convergence') 
      END
C
